    ...
    <div  style="padding-bottom: 90px;margin-bottom: 30px">
        ...
        <div class="Dmain">
            <div class="orderState">
                ...
                <!--<span class="sendBtn">发货</span>-->
                <span class="editDress" @click="address">修改收货地址</span>
                <span class="cancel">取消订单</span>
            </div>
            <div>
                <div>
                    <span class="btn1" @click="show">订单详情</span>
                    <span class="btn2" style="background:#31b0d5;color: white" @click="show2">收货与物流信息</span>
                </div>
                <keep-alive>
